...
if os_decided == "nix" && File.exist?("/usr/bin/apt-get")
	...
	if ARGV[1] == opt_sel[0]
		...
		system(Cmd.net_stat+Messages.output_file_net_stat+fs_ext[0])
		...
		File.open(Messages.output_file_group+fs_ext[0], "w"){ |f| f.write(Variables.group_list_txt_fin)}
		...
		File.open(Messages.output_file_user+fs_ext[0], "w"){ |f| f.write(Variables.user_list_txt_fin)}
		puts Messages.user_list_txt+fs_ext[0]+"."

		# CHKCONFIG Information
		puts ""
		puts Messages.chk_config_txt
		system(Cmd.chk_config+Messages.output_file_chk_config+fs_ext[0])
		...
		puts ""
		puts Messages.net_stat_txt
		system(Cmd.net_stat+Messages.output_file_net_stat+fs_ext[1])
		...
		puts Messages.group_list_txt_fp
		Etc.group {|g| Variables.group_list_txt_fin << g.name + ": " + g.mem.join(', ') + "\n"}
		File.open(Messages.output_file_group+fs_ext[1], "w"){ |f| f.write(Variables.group_list_txt_fin)}
		...
		puts Messages.user_list_txt_fp
		Etc.passwd {|u| Variables.user_list_txt_fin << u.name + " = " + u.gecos + "\n"}
		File.open(Messages.output_file_user+fs_ext[1], "w"){ |f| f.write(Variables.user_list_txt_fin)}
		puts Messages.user_list_txt+fs_ext[1]+"."

		# CHKCONFIG Information
		puts ""
		puts Messages.chk_config_txt
		system(Cmd.chk_config+Messages.output_file_chk_config+fs_ext[1])
...
#####################
	...
	if ARGV[1] == opt_sel[0]
		...
		puts ""
		puts Messages.net_stat_txt
		system(Cmd.net_stat_win+Messages.output_file_net_stat+fs_ext[0])
		puts Messages.net_stat_txt_fin+fs_ext[0]+"."
...
=end
		...
		puts ""
		puts Messages.net_stat_txt
		system(Cmd.net_stat_win+Messages.output_file_net_stat+fs_ext[1])
		puts Messages.net_stat_txt_fin+fs_ext[1]+"."
